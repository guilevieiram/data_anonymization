...
struct __pyx_vtabstruct_4main_Classifier {
  ...
  PyObject *(*initialize_data)(struct __pyx_obj_4main_Classifier *, PyObject *, int __pyx_skip_dispatch);
...
static PyObject *__pyx_f_4main_10Classifier_initialize_data(struct __pyx_obj_4main_Classifier *__pyx_v_self, PyObject *__pyx_v_data_tag, int __pyx_skip_dispatch); /* proto*/
static void __pyx_f_4main_10Classifier_fit(CYTHON_UNUSED struct __pyx_obj_4main_Classifier *__pyx_v_self, CYTHON_UNUSED PyObject *__pyx_v_model, int __pyx_skip_dispatch); /* proto*/
...
static const char __pyx_k_initialize_data[] = "initialize_data";
...
static PyObject *__pyx_n_s_initialize_data;
...
static PyObject *__pyx_pf_4main_10Classifier_10initialize_data(struct __pyx_obj_4main_Classifier *__pyx_v_self, PyObject *__pyx_v_data_tag); /* proto */
 ...
 */
  ...
  __pyx_t_2 = __Pyx_PyDict_GetItem(__pyx_v_self->vocabulary_map, __pyx_v_word); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 18, __pyx_L1_error)
 ...
 */
  ...
  if (unlikely(!Py_OptimizeFlag)) {
    __pyx_t_2 = PyObject_RichCompare(__pyx_v_index, __pyx_int_0, Py_GE); __Pyx_XGOTREF(__pyx_t_2); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 21, __pyx_L1_error)
    ...
    __pyx_t_4 = PyList_GET_SIZE(__pyx_t_2); if (unlikely(__pyx_t_4 == ((Py_ssize_t)-1))) __PYX_ERR(0, 21, __pyx_L1_error)
    __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
    __pyx_t_2 = PyInt_FromSsize_t(__pyx_t_4); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 21, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_2);
    __pyx_t_5 = PyObject_RichCompare(__pyx_v_index, __pyx_t_2, Py_LT); __Pyx_XGOTREF(__pyx_t_5); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 21, __pyx_L1_error)
    __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
 ...
 */
  ...
  __pyx_t_5 = __Pyx_PyObject_GetItem(__pyx_v_self->vocabulary, __pyx_v_index); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 22, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_5);
  if (!(likely(PyString_CheckExact(__pyx_t_5))||((__pyx_t_5) == Py_None)||((void)PyErr_Format(PyExc_TypeError, "Expected %.16s, got %.200s", "str", Py_TYPE(__pyx_t_5)->tp_name), 0))) __PYX_ERR(0, 22, __pyx_L1_error)
...
static void __pyx_f_4main_10Classifier_read_data(struct __pyx_obj_4main_Classifier *__pyx_v_self, PyObject *__pyx_v_path, PyObject *__pyx_v_data_tag, int __pyx_skip_dispatch) {
  ...
  /* Check if overridden in Python */
    ...
    if (unlikely(!__Pyx_object_dict_version_matches(((PyObject *)__pyx_v_self), __pyx_tp_dict_version, __pyx_obj_dict_version))) {
      ...
      #endif
      __pyx_t_1 = __Pyx_PyObject_GetAttrStr(((PyObject *)__pyx_v_self), __pyx_n_s_read_data); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 26, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_1);
 ...
 */
  ...
  if (unlikely(PyDict_SetItem(__pyx_v_self->data, __pyx_v_data_tag, __pyx_v_data) < 0)) __PYX_ERR(0, 28, __pyx_L1_error)
 ...
 */
  /*with:*/ {
    ...
    __Pyx_GOTREF(__pyx_t_2);
    __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
    __pyx_t_7 = __Pyx_PyObject_LookupSpecial(__pyx_t_2, __pyx_n_s_exit); if (unlikely(!__pyx_t_7)) __PYX_ERR(0, 29, __pyx_L1_error)
 ...
 */
          if (likely(PyList_CheckExact(__pyx_v_f)) || PyTuple_CheckExact(__pyx_v_f)) {
            ...
            __pyx_t_11 = -1; __pyx_t_3 = PyObject_GetIter(__pyx_v_f); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 30, __pyx_L7_error)
            __Pyx_GOTREF(__pyx_t_3);
 ...
 */
            __pyx_t_1 = __Pyx_PyObject_GetAttrStr(__pyx_v_line, __pyx_n_s_split); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 31, __pyx_L7_error)
            __Pyx_GOTREF(__pyx_t_1);
            __pyx_t_6 = NULL;
 ...
 */
            __pyx_t_13 = __Pyx_PyObject_IsTrue(__pyx_v_line_content); if (unlikely(__pyx_t_13 < 0)) __PYX_ERR(0, 32, __pyx_L7_error)
 ...
 */
            if ((likely(PyTuple_CheckExact(__pyx_v_line_content))) || (PyList_CheckExact(__pyx_v_line_content))) {
              ...
              #else
              {
                ...
                for (i=0; i < 4; i++) {
                  PyObject* item = PySequence_ITEM(sequence, i); if (unlikely(!item)) __PYX_ERR(0, 33, __pyx_L7_error)
                  __Pyx_GOTREF(item);
                  *(temps[i]) = item;
                }
              }
              ...
              Py_ssize_t index = -1;
              PyObject** temps[4] = {&__pyx_t_2,&__pyx_t_1,&__pyx_t_6,&__pyx_t_4};
              __pyx_t_15 = PyObject_GetIter(__pyx_v_line_content); if (unlikely(!__pyx_t_15)) __PYX_ERR(0, 33, __pyx_L7_error)
              ...
              if (__Pyx_IternextUnpackEndCheck(__pyx_t_16(__pyx_t_15), 4) < 0) __PYX_ERR(0, 33, __pyx_L7_error)
              __pyx_t_16 = NULL;
 ...
 */
            ...
            __pyx_t_17 = PySet_Add(__pyx_v_self->dictionary, __pyx_v_name); if (unlikely(__pyx_t_17 == ((int)-1))) __PYX_ERR(0, 34, __pyx_L7_error)
 ...
 * 
 */
            __pyx_t_14 = (__Pyx_PyString_Equals(__pyx_v_ner, __pyx_kp_s_I_PER, Py_EQ)); if (unlikely(__pyx_t_14 < 0)) __PYX_ERR(0, 37, __pyx_L7_error)
            if (__pyx_t_14) {
 ...
 *                 ))
 */
            __pyx_t_6 = PyTuple_New(2); if (unlikely(!__pyx_t_6)) __PYX_ERR(0, 36, __pyx_L7_error)
            __Pyx_GOTREF(__pyx_t_6);
 ...
 *                     1 if ner == "I-PER" else 0
 */
            __pyx_t_17 = __Pyx_PyList_Append(__pyx_v_data, __pyx_t_6); if (unlikely(__pyx_t_17 == ((int)-1))) __PYX_ERR(0, 35, __pyx_L7_error)
            __Pyx_DECREF(__pyx_t_6); __pyx_t_6 = 0;
 ...
 */
        ...
        /*except:*/ {
          ...
          if (__Pyx_GetException(&__pyx_t_3, &__pyx_t_6, &__pyx_t_4) < 0) __PYX_ERR(0, 29, __pyx_L9_except_error)
          __Pyx_GOTREF(__pyx_t_3);
          __Pyx_GOTREF(__pyx_t_6);
          __Pyx_GOTREF(__pyx_t_4);
          __pyx_t_1 = PyTuple_Pack(3, __pyx_t_3, __pyx_t_6, __pyx_t_4); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 29, __pyx_L9_except_error)
          __Pyx_GOTREF(__pyx_t_1);
          __pyx_t_18 = __Pyx_PyObject_Call(__pyx_t_7, __pyx_t_1, NULL);
          __Pyx_DECREF(__pyx_t_7); __pyx_t_7 = 0;
          __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
          if (unlikely(!__pyx_t_18)) __PYX_ERR(0, 29, __pyx_L9_except_error)
...
static PyObject *__pyx_pw_4main_10Classifier_3read_data(PyObject *__pyx_v_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        ...
        if (likely((values[1] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_data_tag)) != 0)) kw_args--;
          ...
          __Pyx_RaiseArgtupleInvalid("read_data", 1, 2, 2, 1); __PYX_ERR(0, 26, __pyx_L3_error)
        }
      }
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "read_data") < 0)) __PYX_ERR(0, 26, __pyx_L3_error)
      }
  ...
  __Pyx_RaiseArgtupleInvalid("read_data", 1, 2, 2, PyTuple_GET_SIZE(__pyx_args)); __PYX_ERR(0, 26, __pyx_L3_error)
  __pyx_L3_error:;
  __Pyx_AddTraceback("main.Classifier.read_data", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  ...
  if (unlikely(!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_data_tag), (&PyString_Type), 1, "data_tag", 1))) __PYX_ERR(0, 26, __pyx_L1_error)
...
static PyObject *__pyx_pf_4main_10Classifier_2read_data(struct __pyx_obj_4main_Classifier *__pyx_v_self, PyObject *__pyx_v_path, PyObject *__pyx_v_data_tag) {
  ...
  __Pyx_RefNannySetupContext("read_data", 0);
  __Pyx_XDECREF(__pyx_r);
  __pyx_t_1 = __Pyx_void_to_None(__pyx_f_4main_10Classifier_read_data(__pyx_v_self, __pyx_v_path, __pyx_v_data_tag, 1)); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 26, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_r = __pyx_t_1;
  __pyx_t_1 = 0;
  goto __pyx_L0;
...
static void __pyx_f_4main_10Classifier_initialize_vocabulary(struct __pyx_obj_4main_Classifier *__pyx_v_self, int __pyx_skip_dispatch) {
  ...
  /* Check if overridden in Python */
    ...
    if (unlikely(!__Pyx_object_dict_version_matches(((PyObject *)__pyx_v_self), __pyx_tp_dict_version, __pyx_obj_dict_version))) {
      PY_UINT64_T __pyx_type_dict_guard = __Pyx_get_tp_dict_version(((PyObject *)__pyx_v_self));
      #endif
      __pyx_t_1 = __Pyx_PyObject_GetAttrStr(((PyObject *)__pyx_v_self), __pyx_n_s_initialize_vocabulary); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 40, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_1);
 ...
 */
  __pyx_t_1 = PySequence_List(__pyx_v_self->dictionary); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 41, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __Pyx_GIVEREF(__pyx_t_1);
  __Pyx_GOTREF(__pyx_v_self->vocabulary);
  __Pyx_DECREF(__pyx_v_self->vocabulary);
 ...
 */
  ...
  for (;;) {
    ...
    __pyx_t_3 = __Pyx_PyInt_AddObjC(__pyx_t_1, __pyx_int_1, 1, 0, 0); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 42, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_3);
 ...
 */
    ...
    if (unlikely(PyDict_SetItem(__pyx_v_self->vocabulary_map, __pyx_v_word, __pyx_v_i) < 0)) __PYX_ERR(0, 43, __pyx_L1_error)
...
static PyObject *__pyx_pf_4main_10Classifier_4initialize_vocabulary(struct __pyx_obj_4main_Classifier *__pyx_v_self) {
  ...
  __Pyx_RefNannySetupContext("initialize_vocabulary", 0);
  __Pyx_XDECREF(__pyx_r);
  __pyx_t_1 = __Pyx_void_to_None(__pyx_f_4main_10Classifier_initialize_vocabulary(__pyx_v_self, 1)); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 40, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_r = __pyx_t_1;
  __pyx_t_1 = 0;
  goto __pyx_L0;
...
static PyObject *__pyx_f_4main_10Classifier_get_dictionary(struct __pyx_obj_4main_Classifier *__pyx_v_self, int __pyx_skip_dispatch) {
  ...
  /* Check if overridden in Python */
    ...
    if (unlikely(!__Pyx_object_dict_version_matches(((PyObject *)__pyx_v_self), __pyx_tp_dict_version, __pyx_obj_dict_version))) {
      PY_UINT64_T __pyx_type_dict_guard = __Pyx_get_tp_dict_version(((PyObject *)__pyx_v_self));
      #endif
      __pyx_t_1 = __Pyx_PyObject_GetAttrStr(((PyObject *)__pyx_v_self), __pyx_n_s_get_dictionary); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 45, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_1);
      if (!PyCFunction_Check(__pyx_t_1) || (PyCFunction_GET_FUNCTION(__pyx_t_1) != (PyCFunction)(void*)__pyx_pw_4main_10Classifier_7get_dictionary)) {
        ...
        __Pyx_GOTREF(__pyx_t_2);
        __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
        if (!(likely(PySet_CheckExact(__pyx_t_2))||((__pyx_t_2) == Py_None)||((void)PyErr_Format(PyExc_TypeError, "Expected %.16s, got %.200s", "set", Py_TYPE(__pyx_t_2)->tp_name), 0))) __PYX_ERR(0, 45, __pyx_L1_error)
...
static PyObject *__pyx_pf_4main_10Classifier_6get_dictionary(struct __pyx_obj_4main_Classifier *__pyx_v_self) {
  ...
  __Pyx_RefNannySetupContext("get_dictionary", 0);
  __Pyx_XDECREF(__pyx_r);
  __pyx_t_1 = __pyx_f_4main_10Classifier_get_dictionary(__pyx_v_self, 1); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 45, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_r = __pyx_t_1;
  __pyx_t_1 = 0;
  goto __pyx_L0;
...
static PyObject *__pyx_f_4main_10Classifier_get_vocabulary(struct __pyx_obj_4main_Classifier *__pyx_v_self, int __pyx_skip_dispatch) {
  ...
  /* Check if overridden in Python */
    ...
    if (unlikely(!__Pyx_object_dict_version_matches(((PyObject *)__pyx_v_self), __pyx_tp_dict_version, __pyx_obj_dict_version))) {
      PY_UINT64_T __pyx_type_dict_guard = __Pyx_get_tp_dict_version(((PyObject *)__pyx_v_self));
      #endif
      __pyx_t_1 = __Pyx_PyObject_GetAttrStr(((PyObject *)__pyx_v_self), __pyx_n_s_get_vocabulary); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 48, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_1);
      if (!PyCFunction_Check(__pyx_t_1) || (PyCFunction_GET_FUNCTION(__pyx_t_1) != (PyCFunction)(void*)__pyx_pw_4main_10Classifier_9get_vocabulary)) {
        ...
        __Pyx_GOTREF(__pyx_t_2);
        __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
        if (!(likely(PyList_CheckExact(__pyx_t_2))||((__pyx_t_2) == Py_None)||((void)PyErr_Format(PyExc_TypeError, "Expected %.16s, got %.200s", "list", Py_TYPE(__pyx_t_2)->tp_name), 0))) __PYX_ERR(0, 48, __pyx_L1_error)
        __pyx_r = ((PyObject*)__pyx_t_2);
        __pyx_t_2 = 0;
        __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
        goto __pyx_L0;
 ...
 *         return self.vocabulary             # <<<<<<<<<<<<<<
 * 
 *     cpdef initialize_data(self, data_tag: str):
 */
  __Pyx_XDECREF(__pyx_r);
...
static PyObject *__pyx_pf_4main_10Classifier_8get_vocabulary(struct __pyx_obj_4main_Classifier *__pyx_v_self) {
  ...
  __Pyx_RefNannySetupContext("get_vocabulary", 0);
  __Pyx_XDECREF(__pyx_r);
  __pyx_t_1 = __pyx_f_4main_10Classifier_get_vocabulary(__pyx_v_self, 1); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 48, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_r = __pyx_t_1;
  __pyx_t_1 = 0;
  goto __pyx_L0;
 ...
 * 
 *     cpdef initialize_data(self, data_tag: str):             # <<<<<<<<<<<<<<
 *         cdef int vocab_len = len(self.vocabulary)
 *         assert(data_tag in self.data.keys())
 */

static PyObject *__pyx_pw_4main_10Classifier_11initialize_data(PyObject *__pyx_v_self, PyObject *__pyx_v_data_tag); /*proto*/
static PyObject *__pyx_f_4main_10Classifier_initialize_data(struct __pyx_obj_4main_Classifier *__pyx_v_self, PyObject *__pyx_v_data_tag, int __pyx_skip_dispatch) {
  int __pyx_v_vocab_len;
  PyObject *__pyx_v_data = 0;
  ...
  const char *__pyx_filename = NULL;
  int __pyx_clineno = 0;
  __Pyx_RefNannySetupContext("initialize_data", 0);
  /* Check if called by wrapper */
  if (unlikely(__pyx_skip_dispatch)) ;
  /* Check if overridden in Python */
  else if (unlikely((Py_TYPE(((PyObject *)__pyx_v_self))->tp_dictoffset != 0) || (Py_TYPE(((PyObject *)__pyx_v_self))->tp_flags & (Py_TPFLAGS_IS_ABSTRACT | Py_TPFLAGS_HEAPTYPE)))) {
    ...
    if (unlikely(!__Pyx_object_dict_version_matches(((PyObject *)__pyx_v_self), __pyx_tp_dict_version, __pyx_obj_dict_version))) {
      PY_UINT64_T __pyx_type_dict_guard = __Pyx_get_tp_dict_version(((PyObject *)__pyx_v_self));
      #endif
      __pyx_t_1 = __Pyx_PyObject_GetAttrStr(((PyObject *)__pyx_v_self), __pyx_n_s_initialize_data); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 51, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_1);
      if (!PyCFunction_Check(__pyx_t_1) || (PyCFunction_GET_FUNCTION(__pyx_t_1) != (PyCFunction)(void*)__pyx_pw_4main_10Classifier_11initialize_data)) {
        __Pyx_XDECREF(__pyx_r);
        __Pyx_INCREF(__pyx_t_1);
        __pyx_t_3 = __pyx_t_1; __pyx_t_4 = NULL;
        if (CYTHON_UNPACK_METHODS && unlikely(PyMethod_Check(__pyx_t_3))) {
        ...
        __pyx_t_2 = (__pyx_t_4) ? __Pyx_PyObject_Call2Args(__pyx_t_3, __pyx_t_4, __pyx_v_data_tag) : __Pyx_PyObject_CallOneArg(__pyx_t_3, __pyx_v_data_tag);
        __Pyx_XDECREF(__pyx_t_4); __pyx_t_4 = 0;
 ...
 *         cdef int vocab_len = len(self.vocabulary)             # <<<<<<<<<<<<<<
 *         assert(data_tag in self.data.keys())
 *         cdef list data = self.data[data_tag]
 */
  __pyx_t_1 = __pyx_v_self->vocabulary;
  __Pyx_INCREF(__pyx_t_1);
  if (unlikely(__pyx_t_1 == Py_None)) {
    PyErr_SetString(PyExc_TypeError, "object of type 'NoneType' has no len()");
    __PYX_ERR(0, 52, __pyx_L1_error)
  }
  __pyx_t_5 = PyList_GET_SIZE(__pyx_t_1); if (unlikely(__pyx_t_5 == ((Py_ssize_t)-1))) __PYX_ERR(0, 52, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
 ...
 *         assert(data_tag in self.data.keys())             # <<<<<<<<<<<<<<
 *         cdef list data = self.data[data_tag]
 *         cdef int number_points = len(data)
 */
  #ifndef CYTHON_WITHOUT_ASSERTIONS
  if (unlikely(!Py_OptimizeFlag)) {
    if (unlikely(__pyx_v_self->data == Py_None)) {
    ...
    __pyx_t_1 = __Pyx_PyDict_Keys(__pyx_v_self->data); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 53, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_1);
    __pyx_t_6 = (__Pyx_PySequence_ContainsTF(__pyx_v_data_tag, __pyx_t_1, Py_EQ)); if (unlikely(__pyx_t_6 < 0)) __PYX_ERR(0, 53, __pyx_L1_error)
    __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
 ...
 *         cdef list data = self.data[data_tag]             # <<<<<<<<<<<<<<
 *         cdef int number_points = len(data)
 *         cdef int[:, :] X = np.zeros((number_points, vocab_len))
 */
  if (unlikely(__pyx_v_self->data == Py_None)) {
    PyErr_SetString(PyExc_TypeError, "'NoneType' object is not subscriptable");
    __PYX_ERR(0, 54, __pyx_L1_error)
  }
  __pyx_t_1 = __Pyx_PyDict_GetItem(__pyx_v_self->data, __pyx_v_data_tag); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 54, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  if (!(likely(PyList_CheckExact(__pyx_t_1))||((__pyx_t_1) == Py_None)||((void)PyErr_Format(PyExc_TypeError, "Expected %.16s, got %.200s", "list", Py_TYPE(__pyx_t_1)->tp_name), 0))) __PYX_ERR(0, 54, __pyx_L1_error)
  __pyx_v_data = ((PyObject*)__pyx_t_1);
  __pyx_t_1 = 0;
 ...
 *         cdef int number_points = len(data)             # <<<<<<<<<<<<<<
 *         cdef int[:, :] X = np.zeros((number_points, vocab_len))
 *         cdef int[:] y = np.zeros((number_points))
 */
  if (unlikely(__pyx_v_data == Py_None)) {
    PyErr_SetString(PyExc_TypeError, "object of type 'NoneType' has no len()");
    __PYX_ERR(0, 55, __pyx_L1_error)
  }
  __pyx_t_5 = PyList_GET_SIZE(__pyx_v_data); if (unlikely(__pyx_t_5 == ((Py_ssize_t)-1))) __PYX_ERR(0, 55, __pyx_L1_error)
  __pyx_v_number_points = __pyx_t_5;
 ...
 */
  ...
  __Pyx_GOTREF(__pyx_t_3);
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  __pyx_t_2 = __Pyx_PyInt_From_int(__pyx_v_number_points); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 56, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  __pyx_t_4 = __Pyx_PyInt_From_int(__pyx_v_vocab_len); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 56, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_4);
  ...
  __Pyx_GOTREF(__pyx_t_1);
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
  __pyx_t_8 = __Pyx_PyObject_to_MemoryviewSlice_dsds_int(__pyx_t_1, PyBUF_WRITABLE); if (unlikely(!__pyx_t_8.memview)) __PYX_ERR(0, 56, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __pyx_v_X = __pyx_t_8;
 ...
 *         cdef int[:] y = np.zeros((number_points))             # <<<<<<<<<<<<<<
 * 
 *         for idx, (word, ans) in enumerate(data):
 */
  __Pyx_GetModuleGlobalName(__pyx_t_3, __pyx_n_s_np); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 57, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_3);
  __pyx_t_7 = __Pyx_PyObject_GetAttrStr(__pyx_t_3, __pyx_n_s_zeros); if (unlikely(!__pyx_t_7)) __PYX_ERR(0, 57, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_7);
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
  __pyx_t_3 = __Pyx_PyInt_From_int(__pyx_v_number_points); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 57, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_3);
  __pyx_t_4 = NULL;
  ...
  __Pyx_GOTREF(__pyx_t_1);
  __Pyx_DECREF(__pyx_t_7); __pyx_t_7 = 0;
  __pyx_t_9 = __Pyx_PyObject_to_MemoryviewSlice_ds_int(__pyx_t_1, PyBUF_WRITABLE); if (unlikely(!__pyx_t_9.memview)) __PYX_ERR(0, 57, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __pyx_v_y = __pyx_t_9;
 ...
 * 
 *         for idx, (word, ans) in enumerate(data):             # <<<<<<<<<<<<<<
 *             X[idx, self.get_vocabulary_index(word)] = 1
 *             y[idx] = ans
 */
  __pyx_t_5 = 0;
  ...
  for (;;) {
    ...
    #if CYTHON_ASSUME_SAFE_MACROS && !CYTHON_AVOID_BORROWED_REFS
    __pyx_t_7 = PyList_GET_ITEM(__pyx_t_1, __pyx_t_10); __Pyx_INCREF(__pyx_t_7); __pyx_t_10++; if (unlikely(0 < 0)) __PYX_ERR(0, 59, __pyx_L1_error)
    #else
    __pyx_t_7 = PySequence_ITEM(__pyx_t_1, __pyx_t_10); __pyx_t_10++; if (unlikely(!__pyx_t_7)) __PYX_ERR(0, 59, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_7);
    #endif
    if ((likely(PyTuple_CheckExact(__pyx_t_7))) || (PyList_CheckExact(__pyx_t_7))) {
      ...
      Py_ssize_t index = -1;
      __pyx_t_2 = PyObject_GetIter(__pyx_t_7); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 59, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_2);
      __Pyx_DECREF(__pyx_t_7); __pyx_t_7 = 0;
      ...
      __Pyx_GOTREF(__pyx_t_4);
      if (__Pyx_IternextUnpackEndCheck(__pyx_t_11(__pyx_t_2), 2) < 0) __PYX_ERR(0, 59, __pyx_L1_error)
      __pyx_t_11 = NULL;
      __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
    ...
    __Pyx_XDECREF_SET(__pyx_v_word, __pyx_t_3);
    __pyx_t_3 = 0;
    __Pyx_XDECREF_SET(__pyx_v_ans, __pyx_t_4);
    __pyx_t_4 = 0;
 ...
 * 
 */
    if (!(likely(PyString_CheckExact(__pyx_v_word))||((__pyx_v_word) == Py_None)||((void)PyErr_Format(PyExc_TypeError, "Expected %.16s, got %.200s", "str", Py_TYPE(__pyx_v_word)->tp_name), 0))) __PYX_ERR(0, 60, __pyx_L1_error)
    __pyx_t_12 = __pyx_v_idx;
    __pyx_t_13 = ((struct __pyx_vtabstruct_4main_Classifier *)__pyx_v_self->__pyx_vtab)->get_vocabulary_index(__pyx_v_self, ((PyObject*)__pyx_v_word));
    __pyx_t_14 = -1;
    if (__pyx_t_12 < 0) {
    ...
    *((int *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_X.data + __pyx_t_12 * __pyx_v_X.strides[0]) ) + __pyx_t_13 * __pyx_v_X.strides[1]) )) = 1;
 ...
 *         self.X = X
 */
    __pyx_t_14 = __Pyx_PyInt_As_int(__pyx_v_ans); if (unlikely((__pyx_t_14 == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 61, __pyx_L1_error)
    ...
    *((int *) ( /* dim=0 */ (__pyx_v_y.data + __pyx_t_13 * __pyx_v_y.strides[0]) )) = __pyx_t_14;
 ...
 * 
 */
  __pyx_t_1 = __pyx_memoryview_fromslice(__pyx_v_X, 2, (PyObject *(*)(char *)) __pyx_memview_get_int, (int (*)(char *, PyObject *)) __pyx_memview_set_int, 0);; if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 63, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  if (__Pyx_PyObject_SetAttrStr(((PyObject *)__pyx_v_self), __pyx_n_s_X, __pyx_t_1) < 0) __PYX_ERR(0, 63, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
 ...
 */
  __pyx_t_1 = __pyx_memoryview_fromslice(__pyx_v_y, 1, (PyObject *(*)(char *)) __pyx_memview_get_int, (int (*)(char *, PyObject *)) __pyx_memview_set_int, 0);; if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 64, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  if (__Pyx_PyObject_SetAttrStr(((PyObject *)__pyx_v_self), __pyx_n_s_y, __pyx_t_1) < 0) __PYX_ERR(0, 64, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
 ...
 */
  ...
  __Pyx_AddTraceback("main.Classifier.initialize_data", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_r = 0;
  __pyx_L0:;
  __Pyx_XDECREF(__pyx_v_data);
...
/* Python wrapper */
static PyObject *__pyx_pw_4main_10Classifier_11initialize_data(PyObject *__pyx_v_self, PyObject *__pyx_v_data_tag); /*proto*/
static PyObject *__pyx_pw_4main_10Classifier_11initialize_data(PyObject *__pyx_v_self, PyObject *__pyx_v_data_tag) {
  int __pyx_lineno = 0;
  const char *__pyx_filename = NULL;
  int __pyx_clineno = 0;
  PyObject *__pyx_r = 0;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("initialize_data (wrapper)", 0);
  if (unlikely(!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_data_tag), (&PyString_Type), 1, "data_tag", 1))) __PYX_ERR(0, 51, __pyx_L1_error)
  __pyx_r = __pyx_pf_4main_10Classifier_10initialize_data(((struct __pyx_obj_4main_Classifier *)__pyx_v_self), ((PyObject*)__pyx_v_data_tag));
...
static PyObject *__pyx_pf_4main_10Classifier_10initialize_data(struct __pyx_obj_4main_Classifier *__pyx_v_self, PyObject *__pyx_v_data_tag) {
  PyObject *__pyx_r = NULL;
  __Pyx_RefNannyDeclarations
  PyObject *__pyx_t_1 = NULL;
  int __pyx_lineno = 0;
  ...
  __Pyx_RefNannySetupContext("initialize_data", 0);
  __Pyx_XDECREF(__pyx_r);
  __pyx_t_1 = __pyx_f_4main_10Classifier_initialize_data(__pyx_v_self, __pyx_v_data_tag, 1); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 51, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_r = __pyx_t_1;
  __pyx_t_1 = 0;
  goto __pyx_L0;
...
static PyObject *__pyx_pf_4main_10Classifier_12get_X(struct __pyx_obj_4main_Classifier *__pyx_v_self) {
  ...
  __Pyx_XDECREF(__pyx_r);
  __pyx_t_1 = __Pyx_PyObject_GetAttrStr(((PyObject *)__pyx_v_self), __pyx_n_s_X); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 66, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_r = __pyx_t_1;
  __pyx_t_1 = 0;
  goto __pyx_L0;
...
static PyObject *__pyx_pf_4main_10Classifier_14get_y(struct __pyx_obj_4main_Classifier *__pyx_v_self) {
  ...
  __Pyx_XDECREF(__pyx_r);
  __pyx_t_1 = __Pyx_PyObject_GetAttrStr(((PyObject *)__pyx_v_self), __pyx_n_s_y); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 67, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_r = __pyx_t_1;
  __pyx_t_1 = 0;
  goto __pyx_L0;
...
static void __pyx_f_4main_10Classifier_fit(CYTHON_UNUSED struct __pyx_obj_4main_Classifier *__pyx_v_self, CYTHON_UNUSED PyObject *__pyx_v_model, int __pyx_skip_dispatch) {
  __Pyx_RefNannyDeclarations
  PyObject *__pyx_t_1 = NULL;
  PyObject *__pyx_t_2 = NULL;
  PyObject *__pyx_t_3 = NULL;
  ...
  /* Check if overridden in Python */
    ...
    if (unlikely(!__Pyx_object_dict_version_matches(((PyObject *)__pyx_v_self), __pyx_tp_dict_version, __pyx_obj_dict_version))) {
      PY_UINT64_T __pyx_type_dict_guard = __Pyx_get_tp_dict_version(((PyObject *)__pyx_v_self));
      #endif
      __pyx_t_1 = __Pyx_PyObject_GetAttrStr(((PyObject *)__pyx_v_self), __pyx_n_s_fit); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 70, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_1);
...
static PyObject *__pyx_pw_4main_10Classifier_17fit(PyObject *__pyx_v_self, PyObject *__pyx_v_model) {
  ...
  if (unlikely(!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_model), (&PyString_Type), 1, "model", 1))) __PYX_ERR(0, 70, __pyx_L1_error)
...
static PyObject *__pyx_pf_4main_10Classifier_16fit(struct __pyx_obj_4main_Classifier *__pyx_v_self, PyObject *__pyx_v_model) {
  ...
  __Pyx_RefNannySetupContext("fit", 0);
  __Pyx_XDECREF(__pyx_r);
  __pyx_t_1 = __Pyx_void_to_None(__pyx_f_4main_10Classifier_fit(__pyx_v_self, __pyx_v_model, 1)); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 70, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_r = __pyx_t_1;
  __pyx_t_1 = 0;
  goto __pyx_L0;
...
static void __pyx_f_4main_10Classifier_predict(struct __pyx_obj_4main_Classifier *__pyx_v_self, PyObject *__pyx_v_model, int __pyx_skip_dispatch) {
  ...
  /* Check if overridden in Python */
    ...
    if (unlikely(!__Pyx_object_dict_version_matches(((PyObject *)__pyx_v_self), __pyx_tp_dict_version, __pyx_obj_dict_version))) {
      PY_UINT64_T __pyx_type_dict_guard = __Pyx_get_tp_dict_version(((PyObject *)__pyx_v_self));
      #endif
      __pyx_t_1 = __Pyx_PyObject_GetAttrStr(((PyObject *)__pyx_v_self), __pyx_n_s_predict); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 73, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_1);
 ...
 */
  ...
  if (unlikely(!Py_OptimizeFlag)) {
    ...
    __pyx_t_1 = __Pyx_PyDict_GetItem(__pyx_v_self->models, __pyx_v_model); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 74, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_1);
...
static PyObject *__pyx_pw_4main_10Classifier_19predict(PyObject *__pyx_v_self, PyObject *__pyx_v_model) {
  ...
  if (unlikely(!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_model), (&PyString_Type), 1, "model", 1))) __PYX_ERR(0, 73, __pyx_L1_error)
...
static PyObject *__pyx_pf_4main_10Classifier_18predict(struct __pyx_obj_4main_Classifier *__pyx_v_self, PyObject *__pyx_v_model) {
  ...
  __Pyx_RefNannySetupContext("predict", 0);
  __Pyx_XDECREF(__pyx_r);
  __pyx_t_1 = __Pyx_void_to_None(__pyx_f_4main_10Classifier_predict(__pyx_v_self, __pyx_v_model, 1)); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 73, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_r = __pyx_t_1;
  __pyx_t_1 = 0;
  goto __pyx_L0;
...
static PyMethodDef __pyx_methods_4main_Classifier[] = {
  ...
  {"initialize_data", (PyCFunction)__pyx_pw_4main_10Classifier_11initialize_data, METH_O, 0},
...
static __Pyx_StringTabEntry __pyx_string_tab[] = {
  ...
  {&__pyx_n_s_initialize_data, __pyx_k_initialize_data, sizeof(__pyx_k_initialize_data), 0, 0, 1, 1},
 ...
 *         raise __pyx_PickleError("Incompatible checksums (0x%x vs (0x220c7af, 0x62eaf05, 0x178a5fa) = (data, dictionary, models, vocabulary, vocabulary_map))" % __pyx_checksum)
 */
  __pyx_tuple__2 = PyTuple_Pack(3, __pyx_int_35702703, __pyx_int_103722757, __pyx_int_24684026); if (unlikely(!__pyx_tuple__2)) __PYX_ERR(1, 4, __pyx_L1_error)
...
static int __Pyx_modinit_type_init_code(void) {
  ...
  __pyx_vtable_4main_Classifier.initialize_data = (PyObject *(*)(struct __pyx_obj_4main_Classifier *, PyObject *, int __pyx_skip_dispatch))__pyx_f_4main_10Classifier_initialize_data;
  ...
  if (PyType_Ready(&__pyx_type_4main_Classifier) < 0) __PYX_ERR(0, 3, __pyx_L1_error)
  ...
  if (__Pyx_SetVtable(__pyx_type_4main_Classifier.tp_dict, __pyx_vtabptr_4main_Classifier) < 0) __PYX_ERR(0, 3, __pyx_L1_error)
  if (PyObject_SetAttr(__pyx_m, __pyx_n_s_Classifier, (PyObject *)&__pyx_type_4main_Classifier) < 0) __PYX_ERR(0, 3, __pyx_L1_error)
  if (__Pyx_setup_reduce((PyObject*)&__pyx_type_4main_Classifier) < 0) __PYX_ERR(0, 3, __pyx_L1_error)
